...
// command it exports is still `init`.
//
...
import (
	...
	"github.com/lividlabs/codefall-cli/internal/setup/internal/infrastructure"
	"github.com/lividlabs/codefall-cli/internal/setup/internal/presentation"
)

// Register wires setup's object graph into the app's injector. This is the only place the
...
// Command returns setup's command for the composition root to mount. A *cobra.Command is a delivery
