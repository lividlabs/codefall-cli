...
A concept may arrive as more than a conversation: notes, a transcript, a vision document, a
...
is only being renamed. It keeps its original name and extension, and the concept's `Related` line
...
- **Anything less** — the common case, including a document that is nearly right — write a new
  concept from it. Take the user's sentences over your own wherever they work, and put what the
