...
// local runs checks 8 and 9: the project's local start and update commands are declared, and the
...
// runnable is check 9: each declared command names a program that exists. A command that names a
